...
T = TypeVar("T", bound="AssociateWorkflowLabelsRequest")


@_attrs_define
class AssociateWorkflowLabelsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        associate_workflow_labels_request = cls(
            workflow_ids=workflow_ids,
            label_ids=label_ids,
        )

        associate_workflow_labels_request.additional_properties = d
        return associate_workflow_labels_request

...
T = TypeVar("T", bound="CreateCredentialsResponse")
...
class CreateCredentialsResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_credentials_response = cls(
            credentials_id=credentials_id,
        )

        create_credentials_response.additional_properties = d
        return create_credentials_response

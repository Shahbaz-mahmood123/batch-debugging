...
T = TypeVar("T", bound="TraceCompleteResponse")


@_attrs_define
class TraceCompleteResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        trace_complete_response = cls(
            status=status,
            workflow_id=workflow_id,
        )

        trace_complete_response.additional_properties = d
        return trace_complete_response

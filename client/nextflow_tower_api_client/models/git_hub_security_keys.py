...
T = TypeVar("T", bound="GitHubSecurityKeys")


@_attrs_define
class GitHubSecurityKeys:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        git_hub_security_keys = cls(
            username=username,
            password=password,
            discriminator=discriminator,
        )

        git_hub_security_keys.additional_properties = d
        return git_hub_security_keys

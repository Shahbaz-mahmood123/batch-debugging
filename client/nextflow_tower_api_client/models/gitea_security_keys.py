...
T = TypeVar("T", bound="GiteaSecurityKeys")


@_attrs_define
class GiteaSecurityKeys:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        gitea_security_keys = cls(
            username=username,
            password=password,
            discriminator=discriminator,
        )

        gitea_security_keys.additional_properties = d
        return gitea_security_keys
